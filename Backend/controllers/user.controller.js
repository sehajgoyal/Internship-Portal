    ...
    if (file) {
      ...
      try {
        if (process.env.GEMINI_API_KEY) {
          ...
          const prompt = `Analyze this resume text and provide a JSON response exactly in this format without any markdown wrappers or extra text: {"score": 85, "strengths": ["strength1", "strength2"], "improvements": ["improvement1", "improvement2"]}. Here is the resume text:\n\n${resumeText}`;
          ...
          console.warn("GEMINI_API_KEY is not set. Skipping AI Resume Analysis.");
        }
      } catch (e) {
